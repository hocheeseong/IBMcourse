...
@app.callback(
    ...
    [Input(component_id='dropdown-statistics', component_property='value'), Input(component_id='selec-year', component_property='value')])
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(figure=px.histogram(
                                            unemp,
                                            x='unemployment_Rate',
                                            color='Vehicle_Type',
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(
                                            ...
                                            values='Advertising_Expenditure',
                                            names='Vehicle_Type',
                                            title='Advertising Expenditure by Vehicle Type in the year {}'.format(input_year))
                            )
